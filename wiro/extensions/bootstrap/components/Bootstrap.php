...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerDateRangePlugin($selector, $options = array(), $callback = null)
	{
	    ...
	    Yii::app()->clientScript->registerScript($key, '$("' . $selector . '").livequery(function() { $(this).daterangepicker(' . CJavaScript::encode($options) . ($callback ? ', ' . CJavaScript::encode($callback) : '') . '); }); ');
	}
